# Timer
This Timer is designed to help keep a speaker informed of how much time is left for their talk. It is also designed to help a timekeeper keep the event to the schedule.

Minutes and seconds remaining are shown. A circular indicator also shows the fraction of set time that is left.
